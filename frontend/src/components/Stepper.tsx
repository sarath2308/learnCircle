...
interface StepperProps extends HTMLAttributes<HTMLDivElement> {
  ...
  leftContent?: ReactNode; // <-- Pass imagePreview container here
}
    ...
    <div className="flex min-h-full flex-1 flex-col items-center justify-center p-4" {...rest}>
      ...
      >
        ...
        <StepContentWrapper
          ...
          currentStep={currentStep}
          direction={direction}
          className={`flex flex-col md:flex-row gap-6 px-8 py-6 ${contentClassName}`}
        >
          {/* Right: step form/content */}
          <div className="w-full md:w-2/3">{stepsArray[currentStep - 1]}</div>
        </StepContentWrapper>
