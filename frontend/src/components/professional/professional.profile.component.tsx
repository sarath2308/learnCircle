...
const ProfessionalProfileLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: "Payout info", label: "Bookings", icon: <Calendar size={18} /> },
  ];
      ...
      <div className="mx-auto max-w-7xl p-4 md:p-10">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex flex-1 flex-col gap-8">
            ...
            <section className="relative group overflow-hidden rounded-[2.5rem] bg-indigo-600 dark:bg-white p-10 text-white dark:text-slate-900 shadow-2xl transition-all duration-500">
              {/* Ambient Background Glow for that 'Elite' feel */}
              <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-64 h-64 bg-white/10 dark:bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" />

              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-white/10 dark:bg-indigo-600/5 backdrop-blur-xl border border-white/20 dark:border-indigo-600/10">
                    <GraduationCap size={32} className="text-white dark:text-indigo-600" />
                  </div>
                  <div className="text-center md:text-left">
                    <h4 className="text-2xl font-black uppercase tracking-tighter">
                      Begin Your Mastery
                    </h4>
                    <p className="text-indigo-100/70 dark:text-slate-500 text-sm font-medium max-w-md">
                      Join the elite circle of learners and gain access to world-class mentors and
                      exclusive resources.
                    </p>
                  </div>
                </div>
                ...
                <Button
                  ...
                  className="h-14 px-10 bg-white dark:bg-indigo-600 text-indigo-600 dark:text-white hover:scale-105 active:scale-95 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl transition-all group"
                >
                  Sign Up as Learner
                  <ChevronRight
