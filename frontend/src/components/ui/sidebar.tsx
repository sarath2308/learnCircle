...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "hidden md:flex h-full flex-col px-4 py-4 bg-neutral-100 dark:bg-neutral-800 shrink-0",
        className,
      )}
      animate={{
...
export const SidebarLink = ({
  ...
  // If an onClick function is provided, use a <button>; otherwise use <Link>
