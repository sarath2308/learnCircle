  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption:
          "flex justify-center pt-1 relative items-center text-sm font-black uppercase tracking-tighter italic pb-4",
        ...
        button_previous:
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 transition-opacity border-none flex items-center justify-center cursor-pointer",
        button_next:
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 transition-opacity border-none flex items-center justify-center cursor-pointer",
        ...
        weekday:
          "text-slate-400 font-black uppercase text-[10px] h-10 flex items-center justify-center",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        modifiers.today &&
          !modifiers.selected &&
          "bg-slate-200/50 dark:bg-slate-800/50 text-blue-600",
