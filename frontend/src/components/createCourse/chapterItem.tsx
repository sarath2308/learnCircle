    ...
    <AccordionItem value={chapter.id}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="ghost" size="icon"  className="hover:bg-gray-200" onClick={() => onEdit(chapter)}>
            <Pencil className="h-4 w-4" />
          </Button>
          <Button variant="ghost" size="icon" className="hover:bg-red-200" onClick={() => onDelete(chapter.id)}>
      ...
      <AccordionContent>
        <div className="flex justify-end">
           <Button className="bg-green-500"> +Add Lesson</Button>
        </div>
