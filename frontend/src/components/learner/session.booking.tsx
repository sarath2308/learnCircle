            ...
            <Card className="lg:sticky lg:top-8 overflow-hidden border-none shadow-2xl rounded-[2.5rem] md:rounded-[3.5rem] bg-white dark:bg-slate-900">
              ...
              <CardContent className="p-5 md:p-8 space-y-6 md:space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  />
                  <div
                    className={`transition-all duration-300 rounded-[2.5rem] p-4 border-2 shadow-inner
                    ${
                      date
            ...
            `}
                ...
                >
                  {isBookingLoading ? (
                    ...
                    <>
                      <span className="text-base md:text-lg tracking-tight uppercase italic">
                        Confirm Booking
                      </span>
                      {formattedPrice && (
                        <span className="text-[9px] opacity-70 font-bold uppercase tracking-[0.2em]">
