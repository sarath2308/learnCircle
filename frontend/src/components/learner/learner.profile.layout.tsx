          ...
          <aside className="w-full lg:w-72 shrink-0">
            <div className="rounded-3xl bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 p-6 shadow-sm">
              ...
              <div className="mb-8 flex items-center lg:flex-col lg:text-center gap-4">
                ...
                <div>
                  <h2 className="text-lg font-bold text-slate-800 dark:text-white lg:mt-2">{user?.name || "John Doe"}</h2>
                  <p className="text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-tighter">Verified Member</p>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
                <div className="flex flex-col md:flex-row items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/70 dark:text-blue-50/80 text-sm">Join our network and start getting paid for your skills.</p>
                  </div>
                </div>
