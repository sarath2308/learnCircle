...
import { 
  User, Calendar, Settings, LogOut, Briefcase, 
            ...
            <div className="rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-8 shadow-sm">
              <div className="mb-10 flex items-center lg:flex-col lg:text-center gap-4">
                <div className="relative h-20 w-20 lg:h-28 lg:w-28 shrink-0">
                  <img
                    src={user?.profileImg || "https://api.dicebear.com/7.x/avataaars/svg?seed=Felix"}
                    alt="User"
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div className="text-center md:text-left">
                    <h4 className="text-2xl font-black uppercase tracking-tighter">Monetize Expertise</h4>
                    <p className="text-indigo-100/60 text-sm font-medium">Elevate from learner to professional and scale your impact.</p>
                  </div>
                </div>
                <Button className="h-14 px-8 bg-white text-slate-900 hover:bg-slate-100 rounded-2xl font-black uppercase tracking-widest text-xs shadow-lg shadow-black/20 group">
                  Apply Now <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" size={18} />
                </Button>
              </div>
            </section>
          </div>
