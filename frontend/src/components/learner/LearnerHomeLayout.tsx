          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-1">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="relative hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-full transition-colors group"
              >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="relative hover:bg-amber-50 dark:hover:bg-amber-500/10 rounded-full transition-colors group"
              >
        ...
        <div className="fixed inset-0 z-[200] lg:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-[300px] bg-white dark:bg-[#0A0A0A] p-10 flex flex-col animate-in slide-in-from-right duration-500">
            <div className="flex justify-between items-center mb-12">
              <span className="font-black tracking-[0.3em] text-[10px] opacity-40 uppercase">
                Navigation
              </span>
              <Button
                variant="ghost"
