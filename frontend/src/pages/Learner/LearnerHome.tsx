    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 transition-colors duration-300">
      <div className="space-y-20 pb-20 max-w-[1400px] mx-auto pt-10">
        ...
        <section className="relative h-[500px] md:h-[600px] mx-4 rounded-[2.5rem] overflow-hidden bg-slate-100 dark:bg-slate-900 flex items-center px-6 md:px-16">
          ...
          <div className="relative z-10 max-w-2xl space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <Button size="lg" className="h-14 px-8 rounded-2xl bg-slate-900 text-white dark:bg-white dark:text-black hover:bg-blue-600 transition-all font-black">
                Explore Courses <ArrowRight className="ml-2" size={20} />
              </Button>
              <Button variant="outline" size="lg" className="h-14 px-6 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-bold rounded-2xl">
        ...
        <section className="px-6 md:px-10">
          <div className="mb-10">
            <h2 className="text-3xl font-black tracking-tighter uppercase italic text-slate-900 dark:text-white">Trending Now</h2>
            <div className="h-1 w-20 bg-blue-600 mt-2 rounded-full" />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {!courseData.length && <div>
              No course found..
              </div>}
        ...
        <section className="mx-4 bg-slate-50 dark:bg-slate-900/50 rounded-[3rem] py-16 px-6 md:px-16 border border-slate-100 dark:border-slate-800/50 relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-2xl font-black tracking-tighter mb-8 italic dark:text-white text-slate-900">Jump back in</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex gap-5 items-center bg-white dark:bg-slate-950/50 p-6 rounded-[2rem] border border-slate-200 dark:border-white/5 hover:shadow-lg transition-all cursor-pointer group">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm font-black truncate text-slate-900 dark:text-white group-hover:text-blue-600">React Advanced Patterns</h4>
                  ...
                  <p className="text-[9px] font-black text-slate-400 dark:text-white/40 uppercase tracking-widest mt-2">65% COMPLETED</p>
                </div>
              </div>
            </div>
          </div>
