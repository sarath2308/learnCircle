...
import { useGetLearnerCourse, type LearnerCourseData, type LearnerLessonResponseType } from '@/hooks/learner/course/learner.course.get.hook';
...
const LearnerCoursePage = () => {
  ...
  const [lessonData,setLessonData] = useState<LearnerLessonResponseType>({id:"",
  chapterId:"",
  title: "",
  description:"",
  type: "YouTube",
