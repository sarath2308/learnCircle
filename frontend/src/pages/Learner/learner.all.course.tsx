          ...
          filters.sortDate !== 0
            ...
            : "border-slate-200 text-slate-600 dark:border-slate-800 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-700"
              ...
              >
                <Calendar
                  size={14}
                  className={filters.sortDate !== 0 ? "text-indigo-600" : "text-slate-400"}
                />
                Date
                {filters.sortDate !== 0 && (
            ...
            : "border-slate-200 text-slate-600 dark:border-slate-800 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-700"
              ...
              >
                <Star
                  size={14}
                  className={
                    filters.sortRating !== 0 ? "text-indigo-600 fill-indigo-600" : "text-slate-400"
                  }
                />
                Rating
                {filters.sortRating !== 0 && (
          ...
          filters.sortPrice !== 0
            ...
            : "border-slate-200 text-slate-600 dark:border-slate-800 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-700"
              ...
              >
                <Tag
                  size={14}
                  className={filters.sortPrice !== 0 ? "text-indigo-600" : "text-slate-400"}
                />
                Price
                {filters.sortPrice !== 0 && (
                  <span className="ml-1 bg-indigo-600 text-white w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-black scale-110">
            ...
            <div className="flex items-center bg-slate-100 dark:bg-slate-900 px-4 py-2 rounded-2xl border border-slate-200 dark:border-slate-800">
              <p className="text-xs font-bold text-slate-500 uppercase tracking-tight">
                Showing{" "}
                <span className="text-indigo-600 dark:text-indigo-400 font-black px-1">
                  {allCourses.length}
                </span>{" "}
                Results
              </p>
